...
module.exports = function(RED) {
    ...
    function REDvWarn(message){
        if( RED.settings.verbose ) RED.log.warn("Blinkt: " + message);
    }
    
    function REDvInfo(message){
        if( RED.settings.verbose ) RED.log.info("Blinkt: " + message);
    }
    ...
    RED.nodes.registerType("rpi-blinkt out",BlinktOut);
}
